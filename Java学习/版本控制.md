...
2. 下载maven包:http://maven.apache.org/download.cgi

3. windows环境

   - MAVEN_HOME(系统变量) :maven路径
...
编辑文件apache-maven-3.6.1下的conf下的settings.xml
...
在run configuration->add maven->在cmmand line输入 tomcat7:run

1. 本地tomact执行

在run configuration->add tomcat->配置tomcat->deployment,将项目加入到tomcat
...
![image-20210113132735297](https://github.com/kalao/Images/blob/master/版本控制.md/20210113132735297.png)
...
![image-20210113132500205](https://github.com/kalao/Images/blob/master/版本控制.md/20210113132500205.png)



仓库之间的关系

![image-20210113133137973](https://github.com/kalao/Images/blob/master/版本控制.md/20210113133137973.png)
...
![image-20210113134035278](https://github.com/kalao/Images/blob/master/版本控制.md/20210113134035278.png)

![image-20210113134110760](https://github.com/kalao/Images/blob/master/版本控制.md/20210113134110760.png)

![image-20210113133912197](https://github.com/kalao/Images/blob/master/版本控制.md/20210113133912197.png)



![image-20210113135225856](https://github.com/kalao/Images/blob/master/版本控制.md/20210113135225856.png)



## 五命令

![image-20210113135727969](https://github.com/kalao/Images/blob/master/版本控制.md/20210113135727969.png)



- mvn clean 清除target
- mvn compile 编译生成到target
- mvn install 添加到本地仓库,方便其他项目通过gav坐标使用
- mvn deploy将本地jar发表到私有服务器或者远程仓库





![image-20210113141717010](https://github.com/kalao/Images/blob/master/版本控制.md/20210113141717010.png)



![image-20210113141836810](https://github.com/kalao/Images/blob/master/版本控制.md/20210113141836810.png)
...
![image-20210113143633055](https://github.com/kalao/Images/blob/master/版本控制.md/20210113143633055.png)

![image-20210113143907612](https://github.com/kalao/Images/blob/master/版本控制.md/20210113143907612.png)
...
<connection> scm:svn:http://svn.xxxx.com/maven/xxxxx-maven2-trunk(dao-trunk) </connection>
<!-- 给开发者使用的，类似connection元素。即该连接不仅仅只读  -->
<developerConnection> scm:svn:http://svn.xxxx.com/maven/dao-trunk </developerConnection>
